...
class Net(nn.Module):
    ...
    def __init__(self,params):
        ...
        self.conv2 = nn.Sequential(
            ...
            nn.BatchNorm1d(128),
            nn.ReLU(),
            nn.Conv1d(128, 256, kernel_size=params.L2_avgPool_kernel_size, stride=params.L2_avgPool_kernel_size,
                      padding=1),
            nn.BatchNorm1d(256),
            nn.ReLU(),
        ...
        self.conv3 = nn.Sequential(
            nn.Conv1d(256, 128, kernel_size=params.L3_conv_kernel_size,
                      stride=params.L3_conv_kernel_stride,padding=1),
            nn.BatchNorm1d(128),
            nn.ReLU(),
            nn.Conv1d(128, 256, kernel_size=params.L3_avgPool_kernel_size, stride=params.L3_avgPool_kernel_size,
                      padding=1),
            nn.BatchNorm1d(256),
            nn.ReLU(),
        ...
        self.conv4 = nn.Sequential(
            nn.Conv1d(256, 128, kernel_size=params.L4_conv_kernel_size,
                      stride=params.L4_conv_kernel_stride,padding=1),
            nn.BatchNorm1d(128),
            nn.ReLU(),
            nn.Conv1d(128, 256, kernel_size=params.L4_avgPool_kernel_size, stride=params.L4_avgPool_kernel_size,
                      padding=1),
            nn.BatchNorm1d(256),
            nn.ReLU(),
        ...
        self.conv5 = nn.Sequential(
            nn.Conv1d(256, 256, kernel_size=params.L5_conv_kernel_size,
        ...
        self.conv8 = nn.Sequential(
            nn.Conv1d(256, 512, kernel_size=params.L8_conv_kernel_size,
                      stride=params.L8_conv_kernel_stride,padding=1),
            nn.BatchNorm1d(512),
            nn.ReLU(),
            # nn.MaxPool1d(kernel_size=params.L8_avgPool_kernel_size)
            nn.Conv1d(512, 512, kernel_size=params.L8_avgPool_kernel_size, stride=params.L8_avgPool_kernel_size,
                      padding=1),
            nn.BatchNorm1d(512),
            nn.ReLU(),
        )
        ...
        self.conv9 = nn.Sequential(
            nn.Conv1d(512, 512, kernel_size=params.L9_conv_kernel_size,
                      stride=params.L9_conv_kernel_stride,padding=1),
            nn.BatchNorm1d(512),
            nn.ReLU(),
            # nn.MaxPool1d(kernel_size=params.L9_avgPool_kernel_size)
            nn.Conv1d(512, 512, kernel_size=params.L9_avgPool_kernel_size, stride=params.L9_avgPool_kernel_size,
                      padding=1),
            nn.BatchNorm1d(512),
            nn.ReLU(),
        )
        ...
        #     nn.Conv1d(512, 10, kernel_size=1,
        #               stride=1),
        #     nn.ReLU(inplace=True),
        #     nn.AvgPool1d(5),    # if you make this MaxPool1d() instead, will not get good results. This si sbecause avg is linear, were as max is non-linear
        #     nn.Flatten()
        # )
        ...
        self.globalAveragePooling2 = nn.Sequential(
            ...
            nn.BatchNorm1d(10),
            nn.LeakyReLU(inplace=True),
            nn.AvgPool1d(4),    # if you make this MaxPool1d() instead, will not get good results. This si sbecause avg is linear, were as max is non-linear
            nn.Flatten()
        )
