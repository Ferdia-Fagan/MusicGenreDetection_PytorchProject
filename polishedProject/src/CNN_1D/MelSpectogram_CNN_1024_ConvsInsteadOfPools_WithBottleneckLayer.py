...
class Net(nn.Module):
    ...
    def __init__(self,params):
        ...
        self.conv3 = nn.Sequential(
            ...
            nn.BatchNorm1d(128),
            nn.ReLU(inplace=True),
            nn.Conv1d(128, 256,kernel_size=params.L3_maxPool2d_kernel_size, stride=params.L3_maxPool2d_kernel_size, padding=1),
            nn.BatchNorm1d(256),
            nn.ReLU(),
        ...
        self.conv5 = nn.Sequential(
            ...
            nn.BatchNorm1d(128),
            nn.ReLU(inplace=True),
            nn.Conv1d(128, 256, kernel_size=params.L5_maxPool2d_kernel_size, stride=params.L5_maxPool2d_kernel_size,
                      padding=0),
            nn.BatchNorm1d(256),
            nn.ReLU(),
