    ...
    def __init__(self,params):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv1d(params.L1_conv_input_filters_n, 64, kernel_size=params.L1_conv_kernel_size,
                      stride=params.L1_conv_stride, padding=0),
            nn.BatchNorm1d(64),
            nn.ReLU()
        )
        self.conv2 = nn.Sequential(
            nn.Conv1d(64, 64, kernel_size=params.L2_conv_kernel_size,
                      stride=params.L2_conv_stride, padding=0),
            nn.BatchNorm1d(64),
            nn.ReLU(),
            nn.MaxPool1d(kernel_size=params.L2_maxPool2d_kernel_size)
        )
        self.conv3 = nn.Sequential(
            nn.Conv1d(64, 128, kernel_size=params.L3_conv_kernel_size,
        ...
        self.conv4 = nn.Sequential(
            nn.Conv1d(128, 256, kernel_size=params.L4_conv_kernel_size,
                      stride=params.L4_conv_stride, padding=params.padding),
            # nn.Conv1d(128, 256, kernel_size=3, stride=1, padding=1),
            nn.BatchNorm1d(256),
            nn.ReLU(),
            nn.MaxPool1d(kernel_size=params.L4_maxPool2d_kernel_size),
        )
