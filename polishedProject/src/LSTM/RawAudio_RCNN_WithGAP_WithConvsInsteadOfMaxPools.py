...
class Net(nn.Module):
    ...
    def __init__(self, params):
        ...
        self.conv2 = nn.Sequential(
            ...
            # nn.Conv1d(128, 256, kernel_size=3, stride=3,
            #           padding=1),
            # nn.BatchNorm1d(256),
            # nn.ReLU(),
        )
        self.conv3 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.MaxPool1d(kernel_size=3)
            # nn.Conv1d(256, 512, kernel_size=3, stride=3,
            #           padding=1),
            # nn.BatchNorm1d(512),
            # nn.ReLU(),
        )
        ...
        self.globalAveragePooling2 = nn.Sequential(
            ...
            nn.BatchNorm1d(10),
            nn.ReLU(inplace=True),
            nn.AvgPool1d(9),    # if you make this MaxPool1d() instead, will not get good results. This si sbecause avg is linear, were as max is non-linear
            nn.Flatten()
        )
