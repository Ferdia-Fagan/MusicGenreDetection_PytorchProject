...
class Net(nn.Module):
    ...
    def __init__(self,params):
        ...
        self.conv_1 = nn.Conv1d(128, 64, kernel_size=params.conv_l1_kernel_size,
        ...
        self.conv_2 = nn.Conv1d(64, 128, kernel_size=params.conv_l2_kernel_size,
        ...
        self.conv_3 = nn.Conv1d(256, 256, kernel_size=params.conv_l3_kernel_size,
                      stride=params.conv_l3_stride, padding=1)
        self.conv3 = nn.Sequential(
            self.conv_3,
            nn.BatchNorm1d(256),
            nn.ReLU(),
            nn.Conv1d(256, 512, kernel_size=params.l3_maxPool_kernel_size,
                      stride=params.l3_maxPool_kernel_size, padding=1),
            nn.BatchNorm1d(512),
            nn.ReLU(),
        )

        self.conv_4 = nn.Conv1d(512, 256, kernel_size=params.conv_l4_kernel_size,
        ...
        self.globalAveragePooling2 = nn.Sequential(
            ...
            nn.BatchNorm1d(10),
            nn.ReLU(inplace=True),
            nn.AvgPool1d(18),    # if you make this MaxPool1d() instead, will not get good results. This si sbecause avg is linear, were as max is non-linear
            nn.Flatten()
        )
    ...
    def forward(self, input):
        ...
        globalPooling_out = self.globalAveragePooling1(lstm_out.transpose(1,2))
        logits = self.globalAveragePooling2(globalPooling_out)
