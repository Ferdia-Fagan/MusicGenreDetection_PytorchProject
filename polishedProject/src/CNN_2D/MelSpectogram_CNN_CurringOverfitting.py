...
class Net(nn.Module):
    ...
    def __init__(self,params):
        ...
        self.conv1 = nn.Sequential(
            ...
            nn.BatchNorm2d(64),
            nn.ReLU(),
            nn.Conv2d(64, 128, kernel_size=params.L1_maxPool2d_kernel_size, stride=params.L1_maxPool2d_kernel_size,
                      padding=1),
            nn.BatchNorm2d(128),
            nn.ReLU(),
            nn.Dropout(0.1)
        ...
        self.conv2 = nn.Sequential(
            nn.Conv2d(128, 128, kernel_size=params.L2_conv_kernel_size,
                      stride=params.L2_conv_stride,padding=1),
            nn.BatchNorm2d(128),
            nn.ReLU(),
            nn.Conv2d(128, 256, kernel_size=params.L2_maxPool2d_kernel_size, stride=params.L2_maxPool2d_kernel_size,
                      padding=1),
            nn.BatchNorm2d(256),
            nn.ReLU(),
        ...
        self.conv3 = nn.Sequential(
            nn.Conv2d(256, 256, kernel_size=params.L3_conv_kernel_size,
                      stride=params.L3_conv_stride,padding=1),
            nn.BatchNorm2d(256),
            nn.ReLU(),
            nn.Conv2d(256, 512, kernel_size=params.L3_maxPool2d_kernel_size, stride=params.L3_maxPool2d_kernel_size,
                      padding=1),
            nn.BatchNorm2d(512),
            nn.ReLU(),
        ...
        self.conv4 = nn.Sequential(
            nn.Conv2d(512, 512, kernel_size=params.L4_conv_kernel_size,
                      stride=params.L4_conv_stride,padding=1),
            nn.BatchNorm2d(params.L5_conv_output),
            nn.ReLU(),
            nn.Conv2d(512, 1024, kernel_size=params.L4_maxPool2d_kernel_size, stride=params.L4_maxPool2d_kernel_size,
                      padding=1),
            nn.BatchNorm2d(1024),
            nn.ReLU(),
        ...
        self.conv5 = nn.Sequential(
            nn.Conv2d(1024, 512, kernel_size=params.L5_conv_kernel_size,
        ...
        self.globalAveragePooling2 = nn.Sequential(
            ...
            nn.BatchNorm2d(10),
            nn.ReLU(inplace=True),
            nn.AvgPool2d((4,1)),    # if you make this MaxPool1d() instead, will not get good results. This si sbecause avg is linear, were as max is non-linear
            nn.Flatten()
        )
